...
- Si "asksLocation" es true, el usuario preguntó específicamente DÓNDE QUEDA el comercio — priorizá esa respuesta antes que repetir el descuento. Si alguna opción relevante tiene "address", decila clara y concreta (la dirección real). Si "address" es null, decilo honesto ("no tengo la dirección cargada para [comercio]") en vez de ignorar la pregunta y solo repetir el %.
